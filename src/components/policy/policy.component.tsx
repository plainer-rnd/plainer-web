    ...
    return (
        <div>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to Plainer, the software program provided by the Company.</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Plainer.</p>
                </li>
                <li>
            ...
            <h2>Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, You can contact us by email: <b>contact@plainer.co.uk</b></p>
        </div>
    );
};
